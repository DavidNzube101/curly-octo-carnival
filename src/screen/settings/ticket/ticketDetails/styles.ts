...
const styles = StyleSheet.create({
  ...
  textContainer: { marginHorizontal: windowWidth(2.5), flex: 1 },
  sizeFormatted: {
    color: appColors.secondaryFont,
    fontFamily: appFonts.regular,
  },
  file_Name: { fontFamily: appFonts.regular },
  downloadIcon: { right: windowHeight(0.5) },
  list: { paddingBottom: windowHeight(20) },
  screenMainContainer: { flex: 1 },
  textViewShow: {
    position: "absolute",
    bottom: windowHeight(1), marginVertical: windowHeight(3),
    margin: windowHeight(2),
    borderRadius: windowHeight(1), borderWidth: windowHeight(0.1),
  },
  fileFormat: {
