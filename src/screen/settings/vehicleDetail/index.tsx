...
export function VehicleDetail() {
  ...
  useEffect(() => {
    if (selfDriver && selfDriver?.vehicle_info) {
      ...
      const formattedDate = `${RegistrationDate.getDate()} ${
        months[RegistrationDate.getMonth()]
    ...
    <ScrollView style={[styles.main]} showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.subView, { backgroundColor: colors.background }]}>
        <View style={styles.subContainer}>
          ...
          <View style={{bottom:windowHeight(34)}}>
            <Text
              style={[
                styles.selectTitle,
                { color: isDark ? appColors.white : appColors.primaryFont },
          ...
          <View style={{bottom:windowHeight(33)}}>
            <Text
              style={[
                styles.selectTitle1,
                { color: isDark ? appColors.white : appColors.primaryFont },
          ...
          <View style={{bottom:windowHeight(42)}}>
            <Input
              titleShow={true}
          ...
          <View style={{bottom: windowHeight(45)}}>
            <Input
              titleShow={true}
          ...
          <View style={{bottom: windowHeight(43)}}>
            <Text
              style={[
          ...
          <View style={{bottom: windowHeight(48)}}>
            <Input
              titleShow={true}
